...
const STRENGTHS: Strength[] = [
  {
    icon: "🧱",
    title: "견고한 마크업",
    desc: "IE6부터 최신 브라우저까지, 테이블 레이아웃에서 Flexbox·Grid까지 직접 경험하며 쌓은 크로스브라우징 노하우. 어떤 디바이스, 어떤 해상도에서도 흔들리지 않는 UI를 만듭니다. 버튼·입력·페이지 골격처럼 반복되는 마크업은 공통 컴포넌트로 묶어 두어, 한 번 고치면 모든 화면에 같은 모습으로 반영되고 새 화면은 조립만으로 나옵니다. 29CM의 공통 UI 패키지 'ruler'와 이 사이트의 UI Kit·ServiceLayout이 그 방식입니다.",
    tone: "blue",
  },
  {
    icon: "⚛️",
