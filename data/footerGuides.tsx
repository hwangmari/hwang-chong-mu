...
export const DIET_GUIDE_DATA = {
  title: "왜 '아침 vs 저녁' 무게를 비교할까요?",
  tips: [
    {
      icon: "🌙",
      title: "자면서도 살이 빠진다는 사실, 아시나요?",
      description:
        "우리는 잠을 자는 동안에도 에너지를 씁니다(기초대사량). 숙면만 취해도 밤사이 수분과 탄수화물이 분해되어 체중이 자연스럽게 줄어들어요.",
    },
    {
      icon: "📉",
      title: "건강한 감량폭은 '밤사이 -500g' 이상!",
      description:
        "전날 저녁 대비 아침 공복 무게가 0.5kg 이상 줄었다면, 소화와 대사가 완벽하게 이루어졌다는 뜻이에요. 아주 잘하고 계신 거예요! 🎉",
    },
    {
      icon: "🚨",
