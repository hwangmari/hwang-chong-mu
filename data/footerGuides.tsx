...
export const GAME_GUIDE_DATA: GuideData = {
  title: "🎲 상황별 게임 추천 꿀팁",
  story: {
    title: "🤔 '누가 쏠 거야?' 어색한 정적은 이제 그만!",
    content: (
      <>
        맛있게 먹고 계산대 앞에서 서로 눈치만 보던 경험, 다들 있으시죠? 황총무가
        그 고민을 유쾌하게 해결해 드립니다.
      </>
    ),
    solution: {
      title: "🎉 게임으로 정하는 쿨한 더치페이 문화",
      content:
        "방을 만들고 친구들에게 링크만 공유하세요. 별도의 설치 없이 바로 웹에서 게임 한판으로 깔끔하게 정산자를 정할 수 있습니다.",
    },
  },
  tips: [
    {
    ...
    },
    {
      ...
      title: "운명의 '사다리 타기'",
      description:
        "점심 메뉴 고르기부터 벌칙자 선정까지, 하늘에 운을 맡기고 싶을 때 추천!",
    },
    {
      icon: "🎡",
      title: "긴장감 백배 '돌림판'",
      description:
        "회식비 몰아주기 한판? 돌아가는 휠을 보며 심장이 쫄깃해지는 경험을 해보세요.",
    },
    {
      icon: "🔮",
      title: "이심전심 '텔레파시'",
      description:
        "너랑 나랑 얼마나 잘 맞을까? 취향도 알아보고 틀린 사람은 벌주 한 잔!",
    },
  ],
};
